...
class ServiceBObject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServiceBObject', package: const $pb.PackageName('ServiceB'), createEmptyInstance: create)
    ..aInt64(1, 'id')
    ..aOS(2, 'name')
    ..aOS(3, 'alias')
...
class CombinedObject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CombinedObject', package: const $pb.PackageName('ServiceB'), createEmptyInstance: create)
