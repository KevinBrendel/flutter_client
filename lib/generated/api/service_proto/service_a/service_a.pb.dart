...
class ServiceAObject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServiceAObject', package: const $pb.PackageName('service_a'), createEmptyInstance: create)
    ..aInt64(1, 'id')
    ..aOS(2, 'name')
    ..aOB(3, 'condition')
...
class CombinedObject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CombinedObject', package: const $pb.PackageName('service_a'), createEmptyInstance: create)
