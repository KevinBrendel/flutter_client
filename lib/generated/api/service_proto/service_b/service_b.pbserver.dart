...
abstract class ServiceAServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$2.ServiceBObject> getServiceObject($pb.ServerContext ctx, $0.RequestObject request);
  $async.Future<$2.CombinedObject> getCombinedObject($pb.ServerContext ctx, $0.RequestObject request);
